...
function getProcessing($jq){
	if (typeof Processing=='undefined') {
		getScript('http://processingjs.org/content/download/processing-js-0.6/processing-0.6.packed.js',function() {
			if (typeof Processing!='undefined') {
				PJSBox($jq);
			}
		});
...
function PJSBox($jq) {
	...
	if (selected.toString()!="") {
		...
		var codeObjText = anchor.textContent;
		/*if ( anchor != focus ) {
